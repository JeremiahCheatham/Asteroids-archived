...
TARGET := astroids-sdl
SRCFOLD := source
SOURCES := $(SRCFOLD)/$(TARGET).c $(SRCFOLD)/fps.c $(SRCFOLD)/media.c $(SRCFOLD)/player.c $(SRCFOLD)/sprites.c $(SRCFOLD)/sdl_init.c $(SRCFOLD)/shots.c $(SRCFOLD)/astroids.c $(SRCFOLD)/exit.c $(SRCFOLD)/messages.c $(SRCFOLD)/game_mode.c
